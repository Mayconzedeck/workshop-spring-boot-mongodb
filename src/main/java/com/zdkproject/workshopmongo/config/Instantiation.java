package com.zdkproject.workshopmongo.config;
...
import com.zdkproject.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    Instantiation(ResourceExceptionHandler resourceExceptionHandler) {
    }
